  ...
  return (
    <footer className="footer pt-24 pb-12 bg-transparent text-brand-dark overflow-hidden">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="pt-8 border-t border-brand-brown/10 flex flex-col md:flex-row justify-between items-center gap-4 text-brand-muted font-medium">
          <p>© {settings?.copyrightYear || currentYear} {churchName}. All rights reserved.</p>
          <div className="flex gap-8">
            <Link href="/about" className="hover:text-brand-brown transition-colors">교회소개</Link>
            <Link href="/location" className="hover:text-brand-brown transition-colors">오시는 길</Link>
            <Link href="/admin" className="hover:text-brand-brown transition-colors">관리자</Link>
          </div>
        </div>
      </div>
    </footer>
