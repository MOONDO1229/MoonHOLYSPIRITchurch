...
import { Plus, Edit2, Trash2, Video, Save, X, Eye, PlayCircle as Youtube } from 'lucide-react';
  ...
  return (
    <div className="sermon-manager">
      ...
      {!isEditing ? (
        <div className="admin-card table-card">
          <table className="admin-table">
            ...
            <tbody>
              {sermons.sort((a,b) => new Date(b.date) - new Date(a.date)).map(item => (
                <tr key={item.id}>
                  <td>{item.date}</td>
                  ...
                  <td>
                    <div className="action-btns">
                      ...
                      <button className="btn-icon danger" onClick={() => deleteItem('sermons', item.id).then(() => window.location.reload())}><Trash2 size={16} /></button>
                    </div>
                  </td>
                </tr>
              ))}
            ...
            <div className="preview-area">
              ...
              <div className="admin-card video-preview">
                ...
                <div className="preview-info">
                  ...
                  <h3>{current.title}</h3>
                  <p>{current.preacher} | {current.passage}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <style jsx>{`
        ...
        .video-preview { overflow: hidden; padding: 0; }
