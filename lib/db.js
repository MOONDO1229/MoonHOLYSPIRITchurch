...
const DEFAULT_SETTINGS = {
  ...
  visions: [
    ...
    { title: "지역 섬김", content: "퇴촌 지역 사회에 빛과 소금이 되어 이웃을 섬깁니다.", icon: "ShieldCheck" }
  ],
  churchImage: "",
  logoImage: "",
  history: [],
